    ...
    <div class="card border-dark">
          ...
          <div class="card-body text-dark">
              <div class="form-group">
                ...
                value="{{old('email')? old('email'): $item->email}}" aria-describedby="emailHelp" placeholder="Enter email"> -->
                <!--@if ($errors->has('email'))
        ...
        <div class="form-row">
          <div class="col-md-6">
            ...
            value="{{old('name')? old('name'): $item->name}}"
             type="text" aria-describedby="nameHelp" placeholder="Enter first name">
          ...
          <div class="col-md-6">
            ...
            value="{{old('surname')? old('surname'): $item->surname}}" type="text" aria-describedby="nameHelp" placeholder="Enter last name">
      ...
      <div class="form-group">
        <div class="form-row">
          <div class="col-md-6">
            ...
            value="{{old('mobile')? old('mobile'): $item->mobile}}" type="text" aria-describedby="nameHelp" placeholder="Enter first name">
          ...
          <div class="col-md-6">
            ...
            value="{{old('age')? old('age'): $item->age}}" type="text" aria-describedby="nameHelp" placeholder="Enter last name">
      ...
      <div class="form-group">
        <div class="form-row">
          <div class="col-md-6">
            ...
            value="{{old('address')? old('address'): $item->address}}" type="text" aria-describedby="nameHelp" placeholder="Enter first name">
